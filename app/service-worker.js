...
const CACHE_NAME = 'kasir-offline-v10';
...
self.addEventListener('fetch', (event) => {
    ...
    // Konten lintas-origin (foto produk dari Google Drive) sengaja TIDAK di-cache di sini --
    // kalau percobaan pertama gagal (mis. izin share Drive belum sempat aktif sepenuhnya),
    // respons gagalnya bisa ke-cache permanen dan foto jadi rusak terus walau filenya
    // sebenarnya sudah benar. Selalu ambil langsung dari network untuk request lintas-origin.
